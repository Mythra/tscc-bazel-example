...
exports.restoreTsickleDecoratorTransformer = exports.patchTsickleDecoratorTransformer = void 0;
let original;
function patchTsickleDecoratorTransformer() {
    if (!original) {
        const decorators = require('tsickle/out/src/decorators');
...
exports.patchTsickleDecoratorTransformer = patchTsickleDecoratorTransformer;
function restoreTsickleDecoratorTransformer() {
    if (original) {
        require('tsickle/src/decorators').transformDecoratorsOutputForClosurePropertyRenaming = original;
        original = undefined;
    }
}
exports.restoreTsickleDecoratorTransformer = restoreTsickleDecoratorTransformer;
